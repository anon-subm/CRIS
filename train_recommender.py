...
class Instructor:
    ...
    def train(self):
        ...
        criterion = torch.nn.MarginRankingLoss(margin=self.opt.margin, reduction='none')        
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            with torch.no_grad():
                topHits, topNdcgs  = cal_measures(
                    self.vld_loader, self.model, opt, ipdict)
    ...
    def run(self, repeats):
        results = []
        rndseed = [19427, 78036, 37498, 87299, 60330]
